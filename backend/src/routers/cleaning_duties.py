...
from src.services.common_actions import (
    list_all,
    create_one,
    update_one,
    delete_one,
)
from src.services.unique_actions import (
    CleaningDutyCreate,
    CleaningDutyUpdate,
    CleaningDutyResponse,
)
...
async def list_cleaning_duties(db: AsyncSession = Depends(get_db)):
    return await list_all(db, CleaningDuty, CleaningDutyResponse)
